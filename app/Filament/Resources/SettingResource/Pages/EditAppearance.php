                        ...
                        Tabs\Tab::make(__('Logo & Icons'))
                            ...
                            ->schema([
                                Section::make(__(null))
                                    ...
                                    ->columns(3)
                                    ->schema([
                                        Radio::make('design.admin_panel_logo_mode')
                                            ->label(__('Admin panel sidebar logo'))
                                            ->options([
                                                'custom' => __('Custom (website logo or site name)'),
                                                'default_app' => __('Default application logo (built-in)'),
                                            ])
                                            ->default('custom')
                                            ->inline()
                                            ->columnSpanFull()
                                            ->helperText(__('Choose which logo appears in the Filament admin sidebar. Custom uses your uploads below, or the site name if no logo is set.')),
